...
export function Progresso({ passos }: { passos: Map<PassoId, Passo> }) {
  return (
    <section className="rounded-2xl border border-[var(--border)] bg-surface p-6">
      <h2 className="fonte-display mb-5 text-lg font-semibold">Analisando o caso</h2>
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                {fazendo && (
                  <p className="mt-1 text-sm text-muted">{passo.enquanto}</p>
                )}
                {feito && detalhe && (
      ...
      <p className="mt-5 border-t border-[var(--border)] pt-4 text-sm text-muted">
        As duas etapas de leitura e redação passam por um modelo de linguagem e
